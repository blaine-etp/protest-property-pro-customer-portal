...
export function DatabaseSchemaViewer({ onEntitySelect }: DatabaseSchemaViewerProps) {
  ...
  const entities = [
    {
      ...
      relationships: ["owners", "inquiries", "communications"],
      x: 100,
      y: 100,
    },
    {
    ...
    },
    {
      ...
      relationships: ["owners", "bills", "protests", "appeals"],
      x: 700,
      y: 100,
    },
    {
    ...
    },
    {
      ...
      relationships: ["properties", "bills", "appeals", "documents"],
      x: 400,
      y: 350,
    },
    {
      ...
      icon: FileText,
      color: "indigo",
      fields: ["id", "protest_id", "appeal_type", "status", "outcome"],
      relationships: ["protests", "documents"],
      x: 100,
      y: 350,
    },
    {
      ...
      relationships: ["protests", "appeals"],
      x: 400,
      y: 600,
    },
    {
      ...
      icon: Phone,
      color: "cyan",
      fields: ["id", "contact_id", "inquiry_type", "status", "created_at"],
  ...
  const connections = [
    ...
    { from: "protests", to: "appeals", label: "1:1" },
    { from: "protests", to: "documents", label: "1:M" },
    { from: "appeals", to: "documents", label: "1:M" },
    { from: "contacts", to: "inquiries", label: "1:M" },
